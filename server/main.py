"""Entry point for running the play vnt v11 server with uv run main.py."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="play vnt v11 Server",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Run on default port (2004) without SSL
...
""",
    ...
    parser.add_argument(
        ...
        type=int,
        default=2004,
        help="Port number to listen on (default: 2004)",
    )
    parser.add_argument(
        "--ssl-cert",
        dest="ssl_cert",
    ...
    print(f"Starting play vnt v11 server on {protocol}://{args.host}:{args.port}")
