# play vnt v11 Server Architecture

This document describes the server architecture for play vnt v11, including module organization, async boundaries, the client-server protocol, and the relationship between network code and game simulations.
