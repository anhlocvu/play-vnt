...
# play vnt Game Development Guide

This document describes the process for implementing new games in play vnt v11. These steps are followed rigidly by the Xtreme Games Development Group. They work well for both human developers and AI agents.
...
If you haven't implemented a play vnt game before, read at least one existing game that's close to what you're building.
