...
account-approved-welcome = Your account has been approved! Welcome to play vnt!
...
friends-menu-title = Friends
friend-list-menu-title = Your Friends
friend-requests-menu-title = Friend Requests
send-friend-request-menu-title = Send Friend Request
friend-request-received = { $player } sent you a friend request!
friend-request-accepted = { $player } accepted your friend request. You are now friends!
friend-request-sent = Friend request sent to { $player }.
friend-request-already-sent = You already sent a friend request to { $player }.
already-friends = You and { $player } are already friends.
cannot-friend-self = You cannot send a friend request to yourself.
user-not-found = User { $player } not found.
remove-friend-confirm = Are you sure you want to remove { $player } from your friends list?
friend-removed = Removed { $player } from friends.
accept = Accept
reject = Reject
search-user = Search by Username
list-all-users = List All Users
enter-username-prompt = Enter the username of the person you want to friend:
