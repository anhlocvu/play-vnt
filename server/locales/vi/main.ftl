# Thông báo giao diện chính cho play vnt
...
account-approved-welcome = Tài khoản của bạn đã được phê duyệt! Chào mừng đến với play vnt!
...
no-friends = Bạn chưa có người bạn nào.
friends-menu-title = Bạn bè
friend-list-menu-title = Bạn bè của bạn
friend-requests-menu-title = Lời mời đã nhận
send-friend-request-menu-title = Gửi lời mời kết bạn
friend-request-received = { $player } đã gửi lời mời kết bạn cho bạn!
friend-request-accepted = { $player } đã chấp nhận lời mời kết bạn. Hai bạn giờ đã là bạn bè!
friend-request-sent = Đã gửi lời mời kết bạn đến { $player }.
friend-request-already-sent = Bạn đã gửi lời mời kết bạn cho { $player } rồi.
already-friends = Bạn và { $player } đã là bạn bè rồi.
cannot-friend-self = Bạn không thể gửi lời mời kết bạn cho chính mình.
user-not-found = Không tìm thấy người dùng { $player }.
remove-friend-confirm = Bạn có chắc chắn muốn xóa { $player } khỏi danh sách bạn bè không?
friend-removed = Đã xóa { $player } khỏi danh sách bạn bè.
accept = Chấp nhận
reject = Từ chối
search-user = Tìm theo tên người dùng
list-all-users = Hiển thị tất cả người dùng
enter-username-prompt = Nhập tên người dùng bạn muốn kết bạn:
